# DLT to DP new syntax

This folder defines all source code for the 'DLT to DP new syntax' pipeline:
...
* Take a look at the sample under "sample_users_dlt_to_dp_new_syntax.py" to get familiar with the syntax.
